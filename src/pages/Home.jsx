...
import { SERVICES, PORTFOLIO, PROCESS, TEAM, TESTIMONIALS } from '../data';
...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* ── TESTEMUNHOS DE CLIENTES (CARROSSEL COM SETAS) ── */}
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 animate-fade-up gap-8">
            ...
            <div className="hidden md:flex items-center gap-3">
              <button
                ...
                className="p-3 rounded-full border-2 border-blue-500 text-white bg-[#0a0a0a]/80 hover:bg-blue-500 transition-all duration-300 shadow-[0_0_20px_rgba(59,130,246,0.5)] hover:shadow-[0_0_35px_rgba(59,130,246,0.8)] hover:scale-110"
